                            ...
                            <div class="col-12">
                                <form action="index.php" method="get">
                                    ...
                                    <div class="col-7 mb-3">
                                        <label class="form-label" for="numero_estudiantes">Numero de estudiantes</label>
                                        <div class="input-group mb-3">
                                        <input type="number" name="numero_estudiantes" min="1" step="1" class="form-control"
                                        placeholder="Ingresa el numero de estudiantes" 
                                    ...
                                    <tbody>
                                     ...
                                     ?>
                                        <tr>
                                            <td><?=$row?></td>
                                            <td>
                                                <input type="text" name="estudiante[]" class="form-control" placeholder="Ingresa el nombre del estudiante" required>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                            <input type="number" name="parcial[]" class="form-control" 
                                            placeholder="0.00" min="0" max="10" step="0.01" required>
                                            </td>
                                        </tr>
                                        <?php
